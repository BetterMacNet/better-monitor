...
Better Monitor は、プロセス、ネットワーク、ポート、ログイン項目、ハードウェアの状態を 1 つのウインドウにまとめた macOS 用のシステムモニタです。日々の確認にも、問題の切り分けにも使えます。このガイドはバージョン 1.0.2 を対象に、画面ごとに順を追って説明します。
...
7. [ポートとサービス](#ポートとサービス)
8. [ログイン項目](#ログイン項目)
9. [AI プロセス要約と AI 履歴](#ai-プロセス要約と-ai-履歴)
10. [メニューバー](#メニューバー)
11. [設定](#設定)
12. [ショートカット](#ショートカット)
13. [プライバシーとローカルデータ](#プライバシーとローカルデータ)
14. [よくある質問](#よくある質問)
...
または [GitHub Releases](https://github.com/BetterMacNet/better-monitor/releases/latest) から `BetterMonitor-1.0.2.dmg` をダウンロードし、`Better Monitor.app` を「アプリケーション」フォルダにドラッグします。各リリースは Developer ID で署名され、Apple の公証を受けているため、初回起動時にネットワークでの確認は不要です。
...
- **サイドバー**：監視概要、プロセス監視、ネットワーク、ポートとサービス、ログイン項目、AI 履歴、設定の 7 画面。下部のカードに Mac の機種、macOS のバージョン、稼働時間が表示されます。
